...
set $background #1a1c22
set $foreground #eaeff7
...
# Bright colors
set $bright_black #4c566a
set $bright_red #bf616a
set $bright_green #a3be8c
set $bright_yellow #ebcb8b
set $bright_blue #81a1c1
set $bright_magenta #b48ead
set $bright_cyan #8fbcbb
set $bright_white #eceff4


# class			border		background		text		indicator	child_border
client.focused		$cyan		$cyan			$background	#FF0000		$blue
client.urgent		$bright_red	$red			$background	#FF0000		$bright_red
client.unfocused	$black		$background		$cyan		#FF0000		$blue
client.focused_inactive	$cyan		$background		$foreground	#FF0000		$blue
